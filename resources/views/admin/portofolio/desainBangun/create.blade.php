...
@section('link')
<li class="breadcrumb-item "><a href="{{ route('portofolio-desain.index') }}">Desain Bangunan</a></li>
...
<div class="col-12">
    <div class="card">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('portofolio-desain.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-6">   
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="desc" class="form-control summernote" name="deskripsi" id="deskripsi" rows="10"></textarea>
                        </div>
                    </div>
                </div>
            </div>
