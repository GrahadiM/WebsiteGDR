...
@section('link')
<li class="breadcrumb-item "><a href="{{ route('portofolio-kontruksi.index') }}">Kontruksi Bangunan</a></li>
...
<div class="col-12">
    <div class="card">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('portofolio-kontruksi.update', $portofolio->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row">
