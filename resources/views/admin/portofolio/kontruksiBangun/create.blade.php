...
@section('title', 'Create Desain Kontruksi')

@section('link')
<li class="breadcrumb-item "><a href="{{ route('portofolio-kontruksi.index') }}">Desain Kontruksi</a></li>
...
<div class="col-12">
    <div class="card">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('portofolio-kontruksi.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-6">   
