    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('progres-maket.create') }}" class="btn btn-sm btn-outline-primary">Tambah Data</a>
            </div>
        </div>
        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    @if ($progres->pesanan->portofolio->job_id == 3)
                    <tr>
                        <td style="text-transform: capitalize">{{ $progres->pesanan->user->name }}</td>
                        <td style="text-transform: capitalize">{{ $progres->pesanan->portofolio->name }}</td>
                        ...
                        <td>{{ $progres->desc }}</td>
                        <td>
                            <form action="{{ route('progres-maket.destroy', $progres->id) }}" method="POST">
                                {{-- <a href="{{ route('progres-maket.show', $progres->id) }}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a> --}}
                                <a href="{{ route('progres-maket.edit', $progres->id) }}" class="btn btn-sm btn-primary"><i class="fas fa-pencil-alt"></i></a>
                                @csrf
                                @method('DELETE')
