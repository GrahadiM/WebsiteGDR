...
<div class="col-12">
    <div class="card">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('progres-maket.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="pesanan_id" id="pesanan_id" class="custom-select form-control-border border-width-2">
                                ...
                                <option value="{{ $pesanan->id }}">{{ $pesanan->portofolio->name }} pesanan dari {{ $pesanan->user->name }}</option>
                                @endif
                                @endforeach
                            </select>
                            @error('pesanan_id')
