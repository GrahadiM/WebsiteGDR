    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('progres-desain.create') }}" class="btn btn-sm btn-outline-primary">Tambah Data</a>
            </div>
        </div>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $progres->desc }}</td>
                        <td>
                            <form action="{{ route('progres-desain.destroy', $progres->id) }}" method="POST">
                                {{-- <a href="{{ route('progres-desain.show', $progres->id) }}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a> --}}
                                <a href="{{ route('progres-desain.edit', $progres->id) }}" class="btn btn-sm btn-primary"><i class="fas fa-pencil-alt"></i></a>
                                @csrf
                                @method('DELETE')
